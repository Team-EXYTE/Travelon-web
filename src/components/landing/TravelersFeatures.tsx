  ...
  return (
      ...
      ></div>
        ...
        <div className="text-center mb-6 md:mb-8">
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-black mt-4 mb-3 md:mb-4 text-transparent bg-clip-text bg-gradient-to-r from-black via-orange-600 to-black">
              For Travelers
            </h2>
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium">
              Embark on extraordinary journeys with curated experiences that transform ordinary trips into unforgettable adventures.
            </p>
          </div>
