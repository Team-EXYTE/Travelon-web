...
const OtpVerificationModal = ({ isOpen, onClose, phoneNumber, onVerificationSuccess }: OtpVerificationModalProps) => {
    ...
    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-xs flex items-center justify-center p-3 md:p-4">
      <div className="bg-white rounded-xl shadow-lg max-w-md w-full relative animate-fade-in-up">
        ...
        <div className="p-4 md:p-6">
          {step === 'send' && (
            <>
              <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 text-center">Verify Your Phone Number</h3>
              <p className="text-sm md:text-base text-gray-600 text-center mb-4 md:mb-6">
                We&apos;ll send a 6-digit code to <span className="font-semibold">{phoneNumber}</span> to verify your phone number.
              </p>
          ...
          {step === 'verify' && (
            <>
              <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 text-center">Enter Verification Code</h3>
              <p className="text-sm md:text-base text-gray-600 text-center mb-4 md:mb-6">
          ...
          {step === 'success' && (
            <div className="flex flex-col items-center justify-center py-5 md:py-8">
              <div className="bg-green-100 p-3 md:p-4 rounded-full mb-3 md:mb-4">
                <CheckCircle size={24} className="text-green-600 md:w-8 md:h-8" />
              </div>
              <h3 className="text-lg md:text-xl font-semibold mb-1 md:mb-2 text-center">Verification Successful</h3>
          ...
          {step === 'error' && (
            <div className="flex flex-col items-center justify-center py-5 md:py-8">
              ...
              <h3 className="text-lg md:text-xl font-semibold mb-1 md:mb-2 text-center">Verification Failed</h3>
